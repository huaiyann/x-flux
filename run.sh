AE=/home/ubuntu/models/flux.1-dev/ae.safetensors \
    ...
    python3 ./main.py --width=256 --height=256 --seed=10 --model_type=flux-dev --num_steps=30 \
    --prompt='a dog' --device=cuda --num_images_per_prompt=2 --custom_offload=True  --timestep_to_start_cfg=999
