AE=/data/data/flux.1-dev/ae.safetensors \
    FLUX_DEV=/data/data/flux.1-dev/flux1-dev.safetensors \
    T5=/data/xlabs-ai-xflux_text_encoders \
    CLIP=/data/openai-clip-vit-large-patch14 \
